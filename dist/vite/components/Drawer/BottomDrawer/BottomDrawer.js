...
const BottomDrawer = ({ isOpen, onClose, height = "500px", overlayColor = "bg-black/50", drawerColor = "bg-black", closeButton, children, }) => {
    ...
    return (_jsx(AnimatePresence, { children: isOpen && (_jsxs(_Fragment, { children: [_jsx(motion.div, { "data-testid": "drawer-overlay" // ✅ Added test ID
                    ...
                    , "aria-hidden": "true", tabIndex: -1, onClick: onClose }), _jsxs(motion.div, { "data-testid": "drawer-container", className: `fixed bottom-0 left-0 w-full ${drawerColor} rounded-t-3xl shadow-lg z-[60]`, style: { height }, variants: drawerVariants, initial: "hidden", animate: "visible", exit: "exit", transition: { duration: 0.3 }, onClick: (e) => e.stopPropagation(), children: [_jsx("div", { className: "p-4 flex justify-end", children: _jsx("button", { className: "text-gray-600 hover:text-gray-700 p-2 rounded", onClick: onClose, "aria-label": "Close Drawer", children: closeButton || "✕" }) }), _jsx("div", { className: "p-6 text-white", children: children || _jsx("p", { children: "This is the drawer content." }) })] })] })) }));
};
